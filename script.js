...
(function () {
  ...
  function renderReminder(payload) {
    ...
    if (payload.d) {
      ...
      viewDescriptionEl.hidden = false;
    } else {
      viewDescriptionEl.hidden = true;
    }
    ...
    if (payload.l) {
      ...
      viewLocationRow.hidden = false;
    } else {
      viewLocationRow.hidden = true;
    }
  ...
  function startCountdown(targetEpoch) {
    ...
    function tick() {
      ...
      if (diff <= 0) {
        ...
        eventStartedBanner.hidden = false;
        if (countdownIntervalId) {
          clearInterval(countdownIntervalId);
          countdownIntervalId = null;
        }
      ...
      eventStartedBanner.hidden = true;
  ...
  function route() {
    ...
    try {
      ...
      showReminderPage();
      reminderCardEl.hidden = false;
      reminderErrorCard.hidden = true;
      renderReminder(payload);
    } catch (e) {
      showReminderPage();
      reminderCardEl.hidden = true;
      reminderErrorCard.hidden = false;
